...
echo [DevConsole_setup.bat] Success 'mode' set! %time%>> %username%\Downloads\DevConsole-main\DevConsole-main\vSystem\log.txt
set vc=1.0.2
echo [DevConsole_setup.bat] Success 'set' set! %time%>> log.txt
goto CP_error
cls 
...
ECHO currently unable to respond         
ECHO    due to the task below:            
